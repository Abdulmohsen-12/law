...
class _About_screenState extends State<About_screen> {
      ...
      body: Padding(
        ...
        child: Expanded(
          child: Column(
            ...
            children: [
              widget.about_status==0? Text(Constant.Aboutus_txt,style: TextStyle(fontSize: 25,fontWeight: FontWeight.w700,fontFamily: 'Times New Roman'),): Text(Constant.FAqs_txt,style: TextStyle(fontSize: 25,fontWeight: FontWeight.w700,fontFamily: 'Times New Roman'),),
              SizedBox(height: 10,),
  ...
  Future<void> getdetails() async {
    String _responseBody = await APIService.getAPI(Route: ApiRoute.about_description , context: context, show_CircularDialog: false);
